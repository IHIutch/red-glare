...
- [Installation](https://red-glare-docs.jbhutch01.workers.dev/getting-started/installation/): Install Red Glare into a new or existing Astro project.
- [Project structure](https://red-glare-docs.jbhutch01.workers.dev/getting-started/project-structure/): What the files in a Red Glare project do and how they fit together.
- [Quickstart](https://red-glare-docs.jbhutch01.workers.dev/getting-started/quickstart/): Write your first page, preview it locally, and ship a build.
